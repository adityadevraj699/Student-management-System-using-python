...
class Face_Recognition_System:
    ...
    def create_buttons(self):
        ...
        button_data = [
            ("Student Details", "college_images/gettyimages-1022573162.jpg", self.student_details, 200, 150),
            ("Face Detector", "college_images/face_recognition.png", self.face_recognized, 500, 150),
            ("Attendance", "college_images/Attandence.jpg", self.attendance_data, 800, 150),
            ("Help Desk", "college_images/dev.jpg", self.developer_info, 1100, 150),
            ("Train Face", "college_images/Train.jpg", self.train_data, 200, 450),
            ("Photos", "college_images/opencv_face_reco_more_data.jpg", self.open_img, 500, 450),
            ("Developer", "college_images/Team-Management-Software-Development.jpg", self.developer_info, 800, 450),
            ("Exit", "college_images/exit.jpg", self.exit_data, 1100, 450),
        ]
